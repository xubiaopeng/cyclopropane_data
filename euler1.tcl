...
#    puts $com
    ...
    set resd1 [atomselect top "resid 2 and name CA" frame [expr $i+$sep] ]
    set resd2 [atomselect top "resid 5 and name CA" frame [expr $i+$sep] ]
    set resd3 [atomselect top "resid 8 and name CA" frame [expr $i+$sep] ]
    set coord1 [$resd1 get {x y z}]
    set coord2 [$resd2 get {x y z}]
    set coord3 [$resd3 get {x y z}]
    set com [measure center [atomselect top "resid 2 5 8 and name CA" frame [expr $i+$sep] ] ]
